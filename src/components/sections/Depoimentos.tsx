    ...
    >
      <Container>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mb-14 font-serif text-[2.1rem] leading-[1.08] font-light text-ouro-600 italic sm:text-5xl">
            que acompanhei
          </p>
        </div>

        <Revelar y={26} duracao={750}>
          <div className="mx-auto max-w-3xl rounded-[32px] border border-esmeralda-100 bg-white p-10 text-center md:p-14">
            ...
            <div key={indice} className="anima-painel">
              ...
              >
                {Array.from({ length: 5 }, (_, i) => (
                  <Star
                    ...
                    aria-hidden="true"
                    className={cn(
                      i < atual.estrelas ? 'fill-ouro-500 text-ouro-500' : 'text-esmeralda-100',
                    )}
                  />
                ))}
              </div>
              ...
              <blockquote>
                <p className="font-serif text-xl leading-relaxed font-light text-grafite italic md:text-2xl">
                  “{atual.texto}”
                </p>
              </blockquote>

              <p className="mt-8 font-display text-base font-semibold text-esmeralda-700">
                {atual.nome}
              </p>
            ...
            {depoimentos.length > 1 ? (
              <div className="mt-10 flex items-center justify-center gap-4">
                <button
                  ...
                  className="flex h-11 w-11 cursor-pointer items-center justify-center rounded-full border border-esmeralda-200 text-esmeralda-600 transition-all hover:border-esmeralda-700 hover:bg-esmeralda-700 hover:text-white"
                >
                  <ChevronLeft size={18} />
                </button>
